...
ksemillas  <- c(101113, 102013, 103613, 104113, 105613 ) #reemplazar por las propias semillas
...
setwd("X:\\C:\\Users\\PC\\OneDrive\\Documentos\\MCD\\M8_LI\\TEST_LI\\")   #Establezco el Working Directory
#cargo los datos
